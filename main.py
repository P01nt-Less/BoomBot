...
@bot.event
async def on_ready():
    await bot.change_presence(game=discord.Game(name='on {} servers.'.format(len(bot.servers))), status='online')
    print('Online.')
...
async def help(ctx):
    await bot.delete_message(ctx.message)
    embed=discord.Embed(title='Help', description='**CATEGORIES**\n\n!ping - Pong!\n!prefixes - Get the current prefixes.\n\n!thebot - Find commands about The Bot here.\n!informational - Find information about things here.\n!fun - Find fun commands here.\n\n**STAFF CATEGORIES**\n\n\n!moderation - Find moderation commands here.\n!managing - Find managing commands here.', color=0x2874A6)
    embed.set_author(name=f'{ctx.message.author.display_name}', icon_url=f'{ctx.message.author.avatar_url}')
    await bot.say(embed=embed)

@bot.command(pass_context=True)
async def thebot(ctx):
    await bot.delete_message(ctx.message)
    embed=discord.Embed(title='The Bot', description='!info\nGet some info about The Bot.', color=0x2874A6)
    embed.set_author(name=f'{ctx.message.author.display_name}', icon_url=f'{ctx.message.author.avatar_url}')
    await bot.say(embed=embed)

@bot.command(pass_context=True)
async def informational(ctx):
    await bot.delete_message(ctx.message)
    embed=discord.Embed(title='Informational', description='!urbandictionary\nSearch up some words in the Urban Dictionary.\n!cryptocurrency\nFind the current cryptocurrency prices and information about it.', color=0x2874A6)
    embed.set_author(name=f'{ctx.message.author.display_name}', icon_url=f'{ctx.message.author.avatar_url}')
    await bot.say(embed=embed)
...
async def fun(ctx):
    await bot.delete_message(ctx.message)
    embed=discord.Embed(title='Fun', description='!coinflip\nFlip a coin to land on heads or tails.\n!8ball\nAsk the magic 8ball some questions, leaving you with an answer.\n!chucknorris\nGet some Chuck Norris Facts!\n!dog\nGet a random picture of a cute dog!\n!cat\nGet a random picture of a cute cat!\n!comic\nGet a random comic from XKCD.\n!joke\nGet a random, silly joke!', color=0x2874A6)
    embed.set_author(name=f'{ctx.message.author.display_name}', icon_url=f'{ctx.message.author.avatar_url}')
    await bot.say(embed=embed)
...
@bot.command(pass_context=True,aliases=['moderator','moderators','mod','mods','moderating','moderate','moderates','moderater'])
async def moderation(ctx):
    await bot.delete_message(ctx.message)
    embed=discord.Embed(title='Moderation', description='!kick\nKick someone.\n!ban\nBan someone.\n!unban\nUnban someone.\n!clear\nClear messages.\n!mute\nMute someone in the channel.\n!unmute\nUnmute someone in the channel.', color=0x2874A6)
    embed.set_author(name=f'{ctx.message.author.display_name}', icon_url=f'{ctx.message.author.avatar_url}')
    await bot.say(embed=embed)
@bot.command(pass_context=True,aliases=['managing','manage','manages'])
async def manager(ctx):
    await bot.delete_message(ctx.message)
    embed=discord.Embed(title='Managing', description='!addrole\nAdd a role to a user.\n!removerole\nRemove a role from a user.', color=0x2874A6)
    embed.set_author(name=f'{ctx.message.author.display_name}', icon_url=f'{ctx.message.author.avatar_url}')
    await bot.say(embed=embed)
  ######...########.##....##.########.########.....###....##...........######...#######..##.....##.##.....##....###....##....##.########...######.
 ##....##..##.......###...##.##.......##.....##...##.##...##..........##....##.##.....##.###...###.###...###...##.##...###...##.##.....##.##....##
...
@bot.command(pass_context=True, no_pm=True)
async def addrole(ctx, user: discord.Member, *, role:str=None):
    await bot.delete_message(ctx.message)
...
@bot.command(pass_context=True, no_pm=True,aliases=['deleterole'])
async def removerole(ctx, user: discord.Member, *, role:str=None):
    await bot.delete_message(ctx.message)
    if ctx.message.author.server_permissions.manage_roles:
